...
\WP_CLI::add_hook(
	...
	function () {
		...
		\WP_CLI::add_command( 'pronamic i18n make-pot', '\Pronamic\WordPress\Pay\Importer\MakePotCommand' );

		/*
		 * Usage example:
		 *
		 * wp pronamic i18n make-pot . languages/pronamic-pay-importer.pot --slug="pronamic-pay-importer"
		 * wp i18n make-json languages/pronamic-pay-importer-nl_NL.po --no-purge
		 */
	}
);
